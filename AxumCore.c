...
void InitializeMcASP0_dMAX_IRQ()
{
	...
	*(unsigned int *)(McASP0ControlRegistersBase+ACLKXCTL) 	= 0x000000C0; //async
	...
	*(unsigned int *)(McASP0ControlRegistersBase+XCLKCHK) 	= 0x00000000;
	...
	McASP0Serializer[0] = 0x00000009;	//Direct out 1-16
	McASP0Serializer[1] = 0x00000009;	//Direct out 17-32
	McASP0Serializer[2] = 0x00000009;   //Module out 1-16
	McASP0Serializer[3] = 0x00000009;	//Module out 17-32
	McASP0Serializer[4] = 0x00000002;	//Module in 1-16
	McASP0Serializer[5] = 0x00000002;	//Module in 17-32
	McASP0Serializer[6] = 0x00000002;	//Return in 1-16
	McASP0Serializer[7] = 0x00000002;	//Return in 17-32
	McASP0Serializer[8] = 0x00000000;
	McASP0Serializer[9] = 0x00000000;
	...
	*(unsigned int *)(McASP0ControlRegistersBase+PDIR) 		= 0x0000000F;
...
#define	DTCR1 	0xA0
		...
		*(unsigned int *)(dMAXControlRegistersBase+DEER)	|= 0x04000030;
		...
		HiParameterEntry6[2] = 0x01100004;	//bbssllll	bb=block, ss=slots, llll=lines
		HiParameterEntry6[3] = 0x00010010;	//0001ssss -> number of slots
		HiParameterEntry6[4] = 0xFFFDFFD1; // -(lines-1) | -(((lines-1)*slots)-1)
		HiParameterEntry6[5] = 0xFFFDFFC1; // -(lines-1) | -((slots*lines)-1)
		HiParameterEntry6[6] = 0x01100004;
//		HiParameterEntry6[6] = 0x01200002;
		...
		LoParameterEntry7[2] = 0x01100004;	//bbssllll	bb=block, ss=slots, llll=lines (ss = 16, lines = 4)
		LoParameterEntry7[3] = 0x00100001;	//ssss0001 -> number of slots
		LoParameterEntry7[4] = 0xFFD1FFFD; //-(((lines-1)*slots)-1) | -(lines-1)
		LoParameterEntry7[5] = 0xFFC1FFFD; //-((slots*lines)-1) | -(lines-1)
		LoParameterEntry7[6] = 0x01100004;
//		LoParameterEntry7[6] = 0x01200002;
